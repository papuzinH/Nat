          ...
          >
            ...
            >
              <div className="flex items-center gap-4 flex-wrap">
                ...
                <span className="font-body text-[13px] text-ink-soft hidden md:block flex-1">
                ...
                <span
                  className={`font-mono text-[10px] uppercase tracking-[0.1em] px-2.5 py-1 rounded-full flex-shrink-0 ${STATUS_COLORS[order.status] ?? ''}`}
                >
                  {STATUS_OPTIONS.find((s) => s.value === order.status)?.label ?? order.status}
                </span>
                <svg
                  width="12" height="12" viewBox="0 0 12 12" fill="none"
                  className={`flex-shrink-0 transition-transform ${expanded === order.id ? 'rotate-180' : ''}`}
                  aria-hidden="true"
                >
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <label
                    ...
                    className="font-mono text-[10px] uppercase tracking-[0.12em] text-ink-soft flex-shrink-0"
                  >
                    Estado
                  </label>
                  <select
