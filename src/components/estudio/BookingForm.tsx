...
const BookingForm: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <h3 className="font-display font-normal mb-1" style={{ fontSize: '26px' }}>
        Contame tu idea
      </h3>
      <p className="font-body text-ink-soft mb-6" style={{ fontSize: '13px' }}>
      ...
      <form onSubmit={submit} noValidate className="space-y-5">
        <div>
          ...
          />
          {errors.name && <p className="mt-1 font-body" style={{ fontSize: '12px', color: ERROR_COLOR }}>{errors.name}</p>}
        </div>
        ...
        <div>
          <input
            ...
            aria-label="Correo"
          />
          {errors.email && <p className="mt-1 font-body" style={{ fontSize: '12px', color: ERROR_COLOR }}>{errors.email}</p>}
        </div>
        ...
        <div>
          ...
          {errors.area && <p className="mt-1 font-body" style={{ fontSize: '12px', color: ERROR_COLOR }}>{errors.area}</p>}
        </div>
        ...
        <div>
          ...
          />
          {errors.idea && <p className="mt-1 font-body" style={{ fontSize: '12px', color: ERROR_COLOR }}>{errors.idea}</p>}
        </div>

        <button
          type="submit"
          className="w-full font-body font-medium text-[14px] bg-sage-700 text-cream-50 rounded-pill py-3 hover:bg-sage-900 transition-colors duration-200"
        >
          Enviar propuesta
        </button>
      </form>
