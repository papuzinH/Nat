      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className={`text-xl font-title ${isHomePage ? 'text-white' : 'text-gray-800'}`}>
              Natalia Heller
            </h3>
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className={`text-lg font-title ${isHomePage ? 'text-white' : 'text-gray-800'}`}>
              Enlaces rápidos
            </h4>
        ...
        <div className={`mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 ${
          isHomePage ? 'border-t border-white/20' : 'border-t border-cream-200'
        }`}>
